...
data <- read.csv(file = 'C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//Zn_d28//202406_MRI_Reanalysis_KMS_Exp_2_d28_NAS_Tissue_master.csv', header=TRUE, sep=',')
