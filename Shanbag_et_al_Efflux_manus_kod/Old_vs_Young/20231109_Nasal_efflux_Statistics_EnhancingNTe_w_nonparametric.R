...
aov_enhancement_volume_wilcoxon = pairwise.wilcox.test(data_final_time_step$Num_Voxels, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
...
captureOutput(aov_enhancement_volume_wilcoxon, file = filename_txt, append = TRUE)
close(filename_txt)
...
aov_final_cumulative_enhancement_wilcoxon_normalized = pairwise.wilcox.test(data_final_time_step$Cumulative_Sum_Normalized, data_final_time_step$Group, paired = FALSE, p.adjust.method = "BH")
...
captureOutput(aov_final_cumulative_enhancement_wilcoxon_normalized, file = filename_txt, append = TRUE)
