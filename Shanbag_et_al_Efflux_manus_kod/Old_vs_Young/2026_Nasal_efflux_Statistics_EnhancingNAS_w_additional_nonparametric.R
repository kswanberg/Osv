...
directory_name = 'NAS_w_additional_nonparametric' # Should change for each experiment type 
dir.create(directory_name)

# Read in experiment data file 
setwd('E://Efflux_Paper//Data//For_Manuscript//Excel_Files//Old_vs_Young')
data <- read.csv(file = 'E://Efflux_Paper//Data//For_Manuscript//Excel_Files//Old_vs_Young//20240530_old_vs_young_NAS_master.csv', header=TRUE, sep=',')
