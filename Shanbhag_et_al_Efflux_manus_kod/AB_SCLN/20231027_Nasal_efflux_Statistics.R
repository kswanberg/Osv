...
setwd('C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//AB_SCLN//')
data <- read.csv(file = 'C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//AB_SCLN//20241001_AB_Static_KMS_Exp_1.csv', header=TRUE, sep=',')
...
for (i in 9:num_columns){
  ...
  aov_mean_enhancement <- aov(data = data_for_plotting, formula = y ~ Group)
  summary(aov_mean_enhancement)
  aov_mean_enhancement_shapiro_residuals = shapiro.test(residuals(aov_mean_enhancement))
