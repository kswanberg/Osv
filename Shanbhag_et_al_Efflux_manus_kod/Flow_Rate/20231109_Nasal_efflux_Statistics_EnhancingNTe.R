...
data <- read.csv(file = 'C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//Flow_Rate//202406_MRI_Reanalysis_KMS_Exp_1_NTe_master.csv', header=TRUE, sep=',')
