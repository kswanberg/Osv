...
directory_name = 'NAS_Tissue' # Should change for each experiment type 
...
data <- read.csv(file = 'C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//Flow_Rate_Exclusions//202406_MRI_Reanalysis_KMS_Exp_1_NAS_Tissue_master.csv', header=TRUE, sep=',')
