...
directory_name = 'NTe_w_Slopes' # Should change for each experiment type 
dir.create(directory_name)

# Read in experiment data file 
setwd('C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//Flow_Rate_Exclusions//')
data <- read.csv(file = 'C://Users//em6050jo//Documents//Lundgaard_Labb_Swanberg//Efflux_Paper//Data//For_Manuscript//Excel_Files//Flow_Rate_Exclusions//202406_MRI_Reanalysis_KMS_Exp_1_NTe_master.csv', header=TRUE, sep=',')
...
filename_csv = paste0(directory_name,'//Data_with_Slopes_BeforeAfterMaxEnhancement.csv') 
write.csv(data_max_enhancement, filename_csv)


filename_csv = paste0(directory_name,'//Data_with_Slopes_BeforeAfterMaxEnhancement_Normalized.csv') 
write.csv(data_max_enhancement_normalized, filename_csv)
...
p_group <- ggplot(data_by_group, aes(x = Time_Step, y = Sum_Mean, color = Group, ymin=Sum_Mean - Sum_SE, ymax=Sum_Mean + Sum_SE)) +
  ...
  scale_color_manual(values = c("#00BFC4", "#E7B800", "#F8766D"))
...
max_enhance_hist <- ggdensity(data_max_enhancement, x = "Time_Step", xlab ="\nGroup", ylab ="Time (s)\n", 
                    ...
                    palette = c("#00BFC4", "#E7B800", "#F8766D"))+ 
...
glht_posthoc_aov_time_to_max_enhancement <-glht(aov_time_to_max_enhancement, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_time_to_max_enhancement_reported <- summary(glht_posthoc_aov_time_to_max_enhancement, test = adjusted("none")) 

posthoc_aov_time_to_max_enhancement_parametric <- pairwise.t.test(data_max_enhancement$Time_Step, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_time_to_max_enhancement_nonparametric <- pairwise.wilcox.test(data_max_enhancement$Time_Step, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_slope_to_max_enhancement <-glht(aov_slope_to_max_enhancement, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_slope_to_max_enhancement_reported <- summary(glht_posthoc_aov_slope_to_max_enhancement, test = adjusted("none")) 

posthoc_aov_slope_to_max_enhancement_parametric <- pairwise.t.test(data_max_enhancement$Slope_before_Max_Enhancement, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_slope_to_max_enhancement_nonparametric <- pairwise.wilcox.test(data_max_enhancement$Slope_before_Max_Enhancement, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_slope_after_max_enhancement <-glht(aov_slope_after_max_enhancement, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_slope_after_max_enhancement_reported <- summary(glht_posthoc_aov_slope_after_max_enhancement, test = adjusted("none")) 

posthoc_aov_slope_after_max_enhancement_parametric <- pairwise.t.test(data_max_enhancement$Slope_after_Max_Enhancement, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_slope_after_max_enhancement_nonparametric <- pairwise.wilcox.test(data_max_enhancement$Slope_after_Max_Enhancement, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_final_cumulative_enhancement <-glht(aov_final_cumulative_enhancement, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_final_cumulative_enhancement_reported <- summary(glht_posthoc_aov_final_cumulative_enhancement, test = adjusted("none")) 

posthoc_aov_final_cumulative_enhancement_parametric <- pairwise.t.test(data_max_enhancement$Cumulative_Sum, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_final_cumulative_enhancement_nonparametric <- pairwise.wilcox.test(data_max_enhancement$Cumulative_Sum, data_max_enhancement$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_enhancement_volume <-glht(aov_enhancement_volume, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_enhancement_volume_reported <- summary(glht_posthoc_aov_enhancement_volume, test = adjusted("none")) 

posthoc_aov_enhancement_volume_parametric <- pairwise.t.test(data_final_time_step$Num_Voxels, data_final_time_step$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_enhancement_volume_nonparametric <- pairwise.wilcox.test(data_final_time_step$Num_Voxels, data_final_time_step$Group, paired = FALSE, p.adjust.method = "BH")
...
cat("\n\n Time to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_time_to_max_enhancement_reported, file = filename_txt, append = TRUE)
cat("\n\n Time to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_time_to_max_enhancement_parametric, file = filename_txt, append = TRUE)
cat("\n\n Time to Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_time_to_max_enhancement_nonparametric, file = filename_txt, append = TRUE)
...
cat("\n\n Slope to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_slope_to_max_enhancement_reported, file = filename_txt, append = TRUE)
cat("\n\n Slope to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_to_max_enhancement_parametric, file = filename_txt, append = TRUE)
cat("\n\n Slope to Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_to_max_enhancement_nonparametric, file = filename_txt, append = TRUE)
...
cat("\n\n Slope after Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_slope_after_max_enhancement_reported, file = filename_txt, append = TRUE)
cat("\n\n Slope after Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_after_max_enhancement_parametric, file = filename_txt, append = TRUE)
cat("\n\n Slope after Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_after_max_enhancement_nonparametric, file = filename_txt, append = TRUE)
...
cat("\n\n Final Cumulative Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_final_cumulative_enhancement_reported, file = filename_txt, append = TRUE)
cat("\n\n Final Cumulative Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_final_cumulative_enhancement_parametric, file = filename_txt, append = TRUE)
cat("\n\n Final Cumulative Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_final_cumulative_enhancement_nonparametric, file = filename_txt, append = TRUE)
...
cat("\n\n Enhancement Volume Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_enhancement_volume_reported, file = filename_txt, append = TRUE)
cat("\n\n Enhancement Volume Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_enhancement_volume_parametric, file = filename_txt, append = TRUE)
cat("\n\n Enhancement Volume Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_enhancement_volume_nonparametric, file = filename_txt, append = TRUE)
...
glht_posthoc_aov_time_to_max_enhancement_normalized <-glht(aov_time_to_max_enhancement_normalized, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_time_to_max_enhancement_normalized_reported <- summary(glht_posthoc_aov_time_to_max_enhancement_normalized, test = adjusted("none")) 

posthoc_aov_time_to_max_enhancement_normalized_parametric <- pairwise.t.test(data_max_enhancement_normalized$Time_Step, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_time_to_max_enhancement_normalized_nonparametric <- pairwise.wilcox.test(data_max_enhancement_normalized$Time_Step, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_slope_to_max_enhancement_normalized <-glht(aov_slope_to_max_enhancement_normalized, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_slope_to_max_enhancement_normalized_reported <- summary(glht_posthoc_aov_slope_to_max_enhancement_normalized, test = adjusted("none")) 

posthoc_aov_slope_to_max_enhancement_normalized_parametric <- pairwise.t.test(data_max_enhancement_normalized$Slope_before_Max_Enhancement, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_slope_to_max_enhancement_normalized_nonparametric <- pairwise.wilcox.test(data_max_enhancement_normalized$Slope_before_Max_Enhancement, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_slope_after_max_enhancement_normalized <-glht(aov_slope_after_max_enhancement_normalized, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_slope_after_max_enhancement_normalized_reported <- summary(glht_posthoc_aov_slope_after_max_enhancement_normalized, test = adjusted("none")) 

posthoc_aov_slope_after_max_enhancement_normalized_parametric <- pairwise.t.test(data_max_enhancement_normalized$Slope_after_Max_Enhancement, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_slope_after_max_enhancement_normalized_nonparametric <- pairwise.wilcox.test(data_max_enhancement_normalized$Slope_after_Max_Enhancement, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
...
glht_posthoc_aov_final_cumulative_enhancement_normalized <-glht(aov_final_cumulative_enhancement_normalized, linfct = mcp(Group ="Tukey"))
glht_posthoc_aov_final_cumulative_enhancement_normalized_reported <- summary(glht_posthoc_aov_final_cumulative_enhancement_normalized, test = adjusted("none")) 

posthoc_aov_final_cumulative_enhancement_normalized_parametric <- pairwise.t.test(data_max_enhancement_normalized$Cumulative_Sum_Normalized, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
posthoc_aov_final_cumulative_enhancement_normalized_nonparametric <- pairwise.wilcox.test(data_max_enhancement_normalized$Cumulative_Sum_Normalized, data_max_enhancement_normalized$Group, paired = FALSE, p.adjust.method = "BH")
...
cat("\n\n Time to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_time_to_max_enhancement_normalized_reported, file = filename_txt, append = TRUE)
cat("\n\n Time to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_time_to_max_enhancement_normalized_parametric, file = filename_txt, append = TRUE)
cat("\n\n Time to Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_time_to_max_enhancement_normalized_nonparametric, file = filename_txt, append = TRUE)
cat("\n\n Slope to Max Enhancement Descriptives\n", file = filename_txt, append=TRUE, sep = "\n")
...
cat("\n\n Slope to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_slope_to_max_enhancement_normalized_reported, file = filename_txt, append = TRUE)
cat("\n\n Slope to Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_to_max_enhancement_normalized_parametric, file = filename_txt, append = TRUE)
cat("\n\n Slope to Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_to_max_enhancement_normalized_nonparametric, file = filename_txt, append = TRUE)
cat("\n\n Slope after Max Enhancement Descriptives\n", file = filename_txt, append=TRUE, sep = "\n")
...
cat("\n\n Slope after Max Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_slope_after_max_enhancement_normalized_reported, file = filename_txt, append = TRUE)
cat("\n\n Slope after Max Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_after_max_enhancement_normalized_parametric, file = filename_txt, append = TRUE)
cat("\n\n Slope after Max Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_slope_after_max_enhancement_normalized_nonparametric, file = filename_txt, append = TRUE)
cat("\n\n Final Cumulative Enhancement Descriptives\n", file = filename_txt, append=TRUE, sep = "\n")
...
cat("\n\n Final Cumulative Enhancement Parametric Post Hoc Pairwise Comparisons (Tukey-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(glht_posthoc_aov_final_cumulative_enhancement_normalized_reported, file = filename_txt, append = TRUE)
cat("\n\n Final Cumulative Enhancement Parametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_final_cumulative_enhancement_normalized_parametric, file = filename_txt, append = TRUE)
cat("\n\n Final Cumulative Enhancement Nonparametric Post Hoc Pairwise Comparisons (Benjamini-Hochberg-corrected p-values)\n", file = filename_txt, append=TRUE, sep = "\n")
captureOutput(posthoc_aov_final_cumulative_enhancement_normalized_nonparametric, file = filename_txt, append = TRUE)
close(filename_txt)